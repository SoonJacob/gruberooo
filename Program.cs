    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (!exit)
            {
                ...
                {
                    Console.WriteLine("Feature 3 - Create a new order ");
                }
                else if (choice == "4")
                {
                    Console.WriteLine("Feature 4 - Process an order ");
                }
                else if (choice == "5")
                {
                    Console.WriteLine("Feature 5 - Modify an existing order ");
                }
                else if (choice == "6")
                {
                    Console.WriteLine("Feature 6 - Delete an existing order ");
                }
                else if (choice == "0")
                {
                    exit = true;
        ...
        // Helper class to hold order display information just incase like it dont work
        ...
        // Helper method to find which restaurant an order belongs to cos we havent rlly used git yet
        ...
        static void LoadSampleData()
        {
            ...
            OrderedFoodItem ofi1 = new OrderedFoodItem(2, f5); 
            ...
            OrderedFoodItem ofi2 = new OrderedFoodItem(1, f1); 
            OrderedFoodItem ofi3 = new OrderedFoodItem(2, f2); 
            ...
            OrderedFoodItem ofi4 = new OrderedFoodItem(1, f4); 
