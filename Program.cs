    ...
    internal class Program
    {
        ...
        static void LoadSampleData()
        {
            ...
            Order order2 = new Order(
                ...
                "456 Oak Avenue", 
                new DateTime(2026, 2, 13, 18, 30, 0), 
                "Cancelled", 
                "PayPal", 
                true
            );
            ...
            order2.AddOrderedFoodItem(ofi2);
            order2.AddOrderedFoodItem(ofi3);
            c2.AddOrder(order2);
            r1.AddOrder(order2);
